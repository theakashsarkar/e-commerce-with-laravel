													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s6.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s5.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s8.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s7.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s10.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s9.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s12.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{ asset('/') }}frontEnd/images/s11.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
