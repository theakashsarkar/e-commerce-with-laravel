							...
							<div clas="single-top">
								...
								<div class="single-right simpleCart_shelfItem">
									...
									<div class="description">
										<p><span>Quick Overview : </span><p>{{$product->short_description }}</p>
									</div>
                                    {{ Form::open(['route' =>'add-to-cart', 'mathod' =>'POST']) }}
													...
													<div class="descr">
														<div class="reviews-top">
															<div class="reviews-left">
																<img src="{{ asset('/') }}frontEnd/imagesimages/men3.jpg" alt=" " class="img-responsive">
															</div>
